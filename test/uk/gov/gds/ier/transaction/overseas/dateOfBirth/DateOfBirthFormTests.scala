  ...
  it should "describe missing values (month, year)" in {
    ...
    dateOfBirthForm.bind(js).fold(
      hasErrors => {
        ...
        hasErrors.errorMessages("dob.month") should be(Seq("Please enter your month of birth","The month you provided is invalid"))
  ...
  it should "describe missing values (day, month)" in {
    ...
    dateOfBirthForm.bind(js).fold(
      hasErrors => {
        ...
        hasErrors.errorMessages("dob.day") should be(Seq("Please enter your day of birth","The day you provided is invalid"))
        hasErrors.errorMessages("dob.month") should be(Seq("Please enter your month of birth","The month you provided is invalid"))
